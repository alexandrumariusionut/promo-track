...
const { handler: createHandler } = await import('../src/create.mjs');
const { handler: getHandler } = await import('../src/get.mjs');
const { handler: commentsHandler } = await import('../src/comments.mjs');
const { handler: statusHandler } = await import('../src/status.mjs');
const { handler: revokeHandler } = await import('../src/revoke.mjs');
