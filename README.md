...
<p align="center">
  <img src="docs/screenshots/17-dashboard-progress.png" alt="PromoTrack Dashboard" width="800">
</p>
...
<p align="center">
  <img src="docs/screenshots/17-dashboard-progress.png" alt="Dashboard with LP radar chart and completion checklist" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/02-star-narratives-categories.png" alt="STAR Narratives with promotion dimensions" width="700">
</p>

<p align="center">
  <img src="docs/screenshots/03-star-templates.png" alt="Pre-built STAR templates" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/05-ai-formatting-dialog.png" alt="AI formatting with custom instructions" width="700">
</p>

<p align="center">
  <img src="docs/screenshots/06-ai-formatted-output.png" alt="AI-formatted STAR entry with selectable sections" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/08-metrics-scorecard.png" alt="GSD Scorecard with color-coded metrics" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/09-document-preview.png" alt="Promotion document preview" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/10-share-for-review.png" alt="Share for Review with Outlook integration" width="700">
</p>

<p align="center">
  <img src="docs/screenshots/11-manager-review.png" alt="Manager review interface with comment boxes" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/15-profile-page.png" alt="Profile page with employee info and management chain" width="700">
</p>
...
<p align="center">
  <img src="docs/screenshots/16-faq-page.png" alt="FAQ page with categorized help" width="700">
</p>
...
| Feature | Screenshot |
|---------|-----------|
| Dashboard (empty state) | ![](docs/screenshots/01-dashboard-empty.png) |
| Dashboard (with progress) | ![](docs/screenshots/17-dashboard-progress.png) |
| STAR Narratives | ![](docs/screenshots/02-star-narratives-categories.png) |
| STAR Templates | ![](docs/screenshots/03-star-templates.png) |
| STAR Editor | ![](docs/screenshots/04-star-entry-editor.png) |
| AI Formatting | ![](docs/screenshots/05-ai-formatting-dialog.png) |
| AI Output | ![](docs/screenshots/06-ai-formatted-output.png) |
| STAR Cards | ![](docs/screenshots/07-star-entries-cards.png) |
| Metrics Scorecard | ![](docs/screenshots/08-metrics-scorecard.png) |
| Document Preview | ![](docs/screenshots/09-document-preview.png) |
| Share for Review | ![](docs/screenshots/10-share-for-review.png) |
| Manager Review | ![](docs/screenshots/11-manager-review.png) |
| Review Submission | ![](docs/screenshots/12-manager-review-submit.png) |
| Comments Submitted | ![](docs/screenshots/13-review-submitted.png) |
| Entry with Feedback | ![](docs/screenshots/14-star-with-comments.png) |
| Profile | ![](docs/screenshots/15-profile-page.png) |
| FAQ | ![](docs/screenshots/16-faq-page.png) |
